...
export class RegisterVm implements IRegisterVm {
  ...
  init(data?: any) {
    if (data) {
      this.registrationCode = data["registrationCode"] !== undefined ? data["registrationCode"] : <any>null;
  ...
  toJSON(data?: any) {
    data = typeof data === 'object' ? data : {};
    data["registrationCode"] = this.registrationCode !== undefined ? this.registrationCode : <any>null;
